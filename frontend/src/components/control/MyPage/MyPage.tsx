...
import { getMyInfo, getMyType, putMyInfo } from './api';
...
const MyPage = () => {
    ...
    const { data: myData } = useQuery( 'myData', () => getMyInfo())
    ...
    return(
        ...
        { !edit && 
            ...
            <BottomWrapper >
                <div style={{marginTop:'20px', textDecoration: 'underline', color: 'gray'}}>회원탈퇴</div>
        ...
        { edit && 
            ...
            <div>
                { uploadedImage ? (
                    <ModalImg src={ uploadedImage } alt={ UserIcon }/>
                ) : (
