...
const DrawingContent = ( props: ContentProps ) => {
  ...
  return (
    <ContentWrapper>
      <PenWidth>
        <Typography gutterBottom style={{ fontSize: "24px", fontFamily: "JGaegujaengyi" }}>펜 굵기</Typography>
        <PrettoSlider
      ...
      <ColorPalette>
        <Typography gutterBottom style={{ marginRight: "30px", fontSize: "24px", fontFamily: "JGaegujaengyi" }}>펜 색깔</Typography>
